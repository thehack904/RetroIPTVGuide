...
def sanitize_text(text: Any, *, server_hostname: str = "") -> str:
    ...
    # 3. Redact the literal server hostname (whole-word, case-insensitive)
    ...
    # 4. Redact IPv6 before IPv4 (IPv4-mapped IPv6 contains dotted-quads).
    ...
    # 6. Abbreviate home-directory paths
